...
class SECcurve
{
    ...
    public static function curveSecp128r1() {
        $c_params = self::secp128r1Params();
        $curveSecp128r1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp128r1;
    }

    public static function generatorSecp128r1() {
        $c_params = self::secp128r1Params();
        $generatorSecp128r1 = new Point(self::curveSecp128r1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp128r1;
    }

    public static function curveSecp160k1() {
        $c_params = self::secp160k1Params();
        $curveSecp160k1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp160k1;
    }

    public static function generatorSecp160k1() {
        $c_params = self::secp160k1Params();
        $generatorSecp160k1 = new Point(self::curveSecp160k1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp160k1;
    }

    public static function curveSecp160r1() {
        $c_params = self::secp160r1Params();
        $curveSecp160r1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp160r1;
    }

    public static function generatorSecp160r1() {
        $c_params = self::secp160r1Params();
        $generatorSecp160r1 = new Point(self::curveSecp160r1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp160r1;
    }

    public static function curveSecp192k1() {
        $c_params = self::secp192k1Params();
        $curveSecp192k1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp192k1;
    }

    public static function generatorSecp192k1() {
        $c_params = self::secp192k1Params();
        $generatorSecp192k1 = new Point(self::curveSecp192k1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp192k1;
    }

    public static function curveSecp192r1() {
        $c_params = self::secp192r1Params();
        $curveSecp192r1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp192r1;
    }

    public static function generatorSecp192r1() {
        $c_params = self::secp192r1Params();
        $generatorSecp192r1 = new Point(self::curveSecp192r1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp192r1;
    }

    public static function curveSecp224r1() {
        $c_params = self::secp224r1Params();
        $curveSecp224r1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp224r1;
    }

    public static function generatorSecp224r1() {
        $c_params = self::secp224r1Params();
        $generatorSecp224r1 = new Point(self::curveSecp224r1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp224r1;
    }

    public static function curveSecp256r1() {
        $c_params = self::secp256r1Params();
        $curveSecp256r1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp256r1;
    }

    public static function generatorSecp256r1() {
        $c_params = self::secp256r1Params();
        $generatorSecp256r1 = new Point(self::curveSecp256r1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp256r1;
    }

    public static function curveSecp256k1() {
        $c_params = self::secp256k1Params();
        $curveSecp256k1 = new CurveFp($c_params['p'], $c_params['a'], $c_params['b']);

        return $curveSecp256k1;
    }

    public static function generatorSecp256k1() {
        $c_params = self::secp256k1Params();
        $generatorSecp256k1 = new Point(self::curveSecp256k1(), $c_params['x'], $c_params['y'], $c_params['n']);

        return $generatorSecp256k1;
    }
}
